...
{foreign: publicationRepr.authors, repr: personRepr, id: personRepr.id}*/]; //FIXME: doesn't work yet

publicationRepr.reprNew = function(row) {
	return new Publication({id: row.id,
						    title: row.title,
						    numberOfPages: row.nr_of_pages,
						    year: row.published_in_year,
							url: row.url,
							uploaderId: row.published_by_user_id,
