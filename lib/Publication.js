 ...
 * @param {array} data.editors Contains the ID's of all people who have edited the proceeding.
 * @param {array} data.publishers Contains the ID's of all people who have published the proceeding.
 * @param {string} data.city Contains the name of the city where the proceeding was published.
 */
