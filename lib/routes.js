...
var getJournalDisciplines = function(req, res) {
    ...
    getMultiple(params, res, linker.disciplineRepr, 'disciplines');
};
...
var getPersonPublications = function(res, req) {
    var params = {};
    params.query = {id: req.params.id};
    getMultiple(params, res, linker.publicationRepr, 'publications');
};
