...
module.exports = {
  ...
  '/disciplines': {
    'get': function(req, res) {
      ...
      var result = dbManager.getDiscipline(params, function(disciplines) {
        var varDis = [];
        var result = db.getDiscipline(params, function(disciplines) {
          varDis = [];
  ...
  '/journals': {
    'get': function(req, res) {
      var db = new DBManager(config);
      var params = paramsFromQuery(req.query);
      db.getJournal(params, function(journals) {
          var Jou = [];
  ...
  '/journals/:id': {
    'get': function(req, res) {
      var db = new DBManager(config);
      db.getJournal({id: req.params.id}, function(journals) {
