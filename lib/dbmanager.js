...
DBManager.prototype.put = function(jsonObj, classObj, next) {
    var query = linker.queryUpdate(jsonObj, classObj);
    ...
    this.executeQuery(query, jsonObj, onSuccess);
};
...
DBManager.prototype.postPublication = function(jsonObj, next){
    ...
    var queryParams = {publication_type: jsonObj.type, title: jsonObj.title,
                      ...
                      published_by_user_id: jsonObj.uploader, summary_text: jsonObj.abstract};
