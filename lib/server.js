...
module.exports = function (app) {
    ...
    _routes.forEach(function (operations, path) {
        ...
        _methods.forEach(function (method) {
            ...
            app[method](path, operations[method] || errorPage);
        });
    });
    
    //Temporary fix: access to restricted info
    app.get('/restricted.json', jwt({secret: secret.secretToken}), function(req, res) {
