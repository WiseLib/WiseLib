...
var searchPerson = function (req, response) {
	...
	// 				.and(dbscheme.person.last_name.like('%' + lastName + '%'))).toQuery();
...
var getStartPage = function (req, res) {
    res.sendFile(path.resolve('../../Client/src/app/index.html')); // load the single view file (angular will handle the page changes on the front-end)
};
